...
class TransactionController extends Controller
{
    ...
    private function _fullyBookedChecker(Store $request){
        ...
        $runningTransactionCount = Transaction::whereListingId($listing->id)->whereNot('status', 'cancelled')->where(function($query) use ($request){
    ...
    public function show(Transaction $transaction):JsonResponse
    {
        ...
        return response()->json([
            'success' => true,
            'message' => "Get my detail transaction",
            'data' => $transaction,
        ]);
    }
