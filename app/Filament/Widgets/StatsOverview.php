...
class StatsOverview extends BaseWidget
{
    ...
    {
        $newListings = Listing::whereMonth('created_at', Carbon::now()->month)->whereYear('created_at', Carbon::now()->year)->count();
        ...
        $transactionPercentage = number_format($transactionPercentage, 2);

        $revenuePercentage = number_format($revenuePercentage, 2);
        return [
            Stat::make('New listing of the month', $newListings),
